...
public class HuffmanEncoding {
	...
	// PARTE NOVA CRIADA PARA AUXILIAR NA OBTENCAO DO CODIGO DE HUFFMAN

	public HashMap<Character, String> returnEncoding(){

		HashMap <Character, String> resp = new HashMap <Character, String>();
		returnEncodingAux(bt.getRoot(),"", resp);
		return resp;
		
	}
	
	private void returnEncodingAux(Node n, String code, HashMap<Character, String> resp){
		
		if(n.getLeftChild() == null && n.getRightChild() == null){
			//System.out.println(n.character+" - "+code);
			resp.put(n.character, code);
			return;
		}
		...
		returnEncodingAux(n.getLeftChild(), code+"0", resp);
		returnEncodingAux(n.getRightChild(), code+"1", resp);
	}
}
